...
urlpatterns = [
    ...
    path('register/fdo/', register_fdo, name='register_front_desk'),
    path('register/dh/', register_dh, name='register_dokter_hewan'),
    path('register/ph/', register_ph, name='register_perawat_hewan'),
